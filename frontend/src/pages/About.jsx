  ...
  return (
    <div className="px-20">
      ...
      <div className="flex flex-col md:flex-row mb-20 gap-1">
        <div className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col text-[15px] hover:bg-primary hover:text-normal transition-all duration-300 cursor-pointer">
          <b>EFFICIENCY:</b>
